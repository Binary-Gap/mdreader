...
;hljs.registerLanguage("dart",e)})();/*! `scala` grammar compiled for Highlight.js 11.9.0 */
...
begin:"@[A-Za-z]+"}]}}})();hljs.registerLanguage("scala",e)})();/*! `dockerfile` grammar compiled for Highlight.js 11.9.0 */
...
;hljs.registerLanguage("dockerfile",e)})();/*! `haskell` grammar compiled for Highlight.js 11.9.0 */
...
begin:`(?!-)${i}--+|--+(?!-)${i}`},s,{begin:"->|<-"}]}}})()
;hljs.registerLanguage("haskell",e)})();/*! `elixir` grammar compiled for Highlight.js 11.9.0 */
(()=>{var e=(()=>{"use strict";return e=>{
